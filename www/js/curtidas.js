  ...
  $.ajax({
    ...
    success: function (json) {
      ...
      if (json[0]['res'] == 1){
        ...
        $('#noti').append('<div style="text-align:center;margin-top:10%;font-size:1.5em;width:80%;margin-left:10%;font-family:Lato-Light;">Ninguém curtiu essa publicação.</div>');
      }
