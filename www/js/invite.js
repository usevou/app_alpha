  ...
  success: function (json) {
    if (json[0]['res'] == 1){
      ...
      for ( var i=0;i<json.length;i++ ){
        ...
        html += '<div class="card">'+
          '<div class="amigos">Convidado por: <span style="color:#652C90;" onclick="localStorage.setItem(\'viewProfile\','+json[i]['idusu']+');window.location.href=\'../menu_lat/profile.html\'">'+json[i]['nome_usu']+'</span></div>'+
      ...
      $('#conteudo').html('<div style="float:left;text-align:center;margin:10%;font-size:1.5em;width:80%;font-family:Lato-Light;">Não há nenhum convite pendente.</div>');
    }
